...
class QueueBase(Model):
    ...
    def __init__(self, name=None, alias=None, state=None, type=None, category=None, description=None, reserved_int1=None, reserved_int2=None, reserved_string1=None, reserved_string2=None):
