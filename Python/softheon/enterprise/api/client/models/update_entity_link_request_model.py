...
class UpdateEntityLinkRequestModel(Model):
    ...
    def __init__(self, virtual_name=None, class_property=None, name=None, acl=None, page_number=None, state=None, note=None):
        super(UpdateEntityLinkRequestModel, self).__init__()
