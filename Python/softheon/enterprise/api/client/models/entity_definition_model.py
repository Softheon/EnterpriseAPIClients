...
class EntityDefinitionModel(Model):
    ...
    def __init__(self, type, category, name, id=None, creation_time=None, modification_time=None, has_class=None, has_security=None, has_profiles=None, has_items=None, small_image=None, large_image=None, has_audit=None, allows_view_images=None, is_review_state=None, reserved_string1=None, reserved_string2=None, reserved_int1=None, reserved_int2=None, drawers=None, profiles=None):
        super(EntityDefinitionModel, self).__init__()
        self.id = id
