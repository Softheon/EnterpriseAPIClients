...
class QueueAssignmentModel(Model):
    ...
    _validation = {
        ...
        'group_id': {'maximum': 2147483647, 'minimum': 0},
    }
    ...
    def __init__(self, queue_id=None, user_id=None, group_id=None, type=None, order=None, task_sort_column=None, state=None, fetch_type=None):
        super(QueueAssignmentModel, self).__init__()
