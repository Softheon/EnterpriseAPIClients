...
class GetNoteRequestModel(Model):
    ...
    _validation = {
        ...
        'parent_id': {'maximum': 2147483647, 'minimum': 1},
    ...
    def __init__(self, drawer_id, entity_id=None, name=None, creator_user_id=None, modifier_user_id=None, min_creation_time=None, max_creation_time=None, min_modification_time=None, max_modification_time=None, parent_id=None, page=None, page_size=None, sort_order=None, sort_by=None):
        super(GetNoteRequestModel, self).__init__()
