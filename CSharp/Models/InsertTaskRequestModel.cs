...
namespace Softheon.Enterprise.Api.Client.Models
{
    ...
    /// </summary>
    public partial class InsertTaskRequestModel
    {
        /// <summary>
        /// Initializes a new instance of the InsertTaskRequestModel class.
        /// </summary>
        public InsertTaskRequestModel()
        {
            CustomInit();
        }
        ...
        public virtual void Validate()
        {
            ...
            if (ObjectID > 2147483647)
            {
                throw new ValidationException(ValidationRules.InclusiveMaximum, "ObjectID", 2147483647);
            }
            if (ObjectID < 1)
            {
                throw new ValidationException(ValidationRules.InclusiveMinimum, "ObjectID", 1);
            }
            if (ObjectType > 2147483647)
            {
                throw new ValidationException(ValidationRules.InclusiveMaximum, "ObjectType", 2147483647);
            }
            if (ObjectType < 1)
            {
                throw new ValidationException(ValidationRules.InclusiveMinimum, "ObjectType", 1);
            }
            if (PrevQueueID > 2147483647)
            {
                throw new ValidationException(ValidationRules.InclusiveMaximum, "PrevQueueID", 2147483647);
            }
            if (PrevQueueID < 0)
            {
                throw new ValidationException(ValidationRules.InclusiveMinimum, "PrevQueueID", 0);
            }
            if (NextQueueID > 2147483647)
            {
                throw new ValidationException(ValidationRules.InclusiveMaximum, "NextQueueID", 2147483647);
            }
            if (NextQueueID < 0)
            {
                throw new ValidationException(ValidationRules.InclusiveMinimum, "NextQueueID", 0);
            }
