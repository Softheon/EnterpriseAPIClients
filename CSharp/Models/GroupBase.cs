...
namespace Softheon.Enterprise.Api.Client.Models
{
    ...
    public partial class GroupBase
    {
        ...
        /// string2.</param>
        public GroupBase(string name, int? userID = default(int?), string type = default(string), string state = default(string), int? reservedInt1 = default(int?), int? reservedInt2 = default(int?), string reservedString1 = default(string), string reservedString2 = default(string))
        {
            UserID = userID;
            Name = name;
            Type = type;
