...
namespace Softheon.Enterprise.Api.Client.Models
{
    ...
    /// </summary>
    public partial class EntityDefinitionBase
    {
        /// <summary>
        /// Initializes a new instance of the EntityDefinitionBase class.
        /// </summary>
        public EntityDefinitionBase()
        {
            CustomInit();
        }
