...
namespace Softheon.Enterprise.Api.Client.Models
{
    ...
    /// </summary>
    public partial class WorkflowQueueModel
    {
        /// <summary>
        /// Initializes a new instance of the WorkflowQueueModel class.
        /// </summary>
        public WorkflowQueueModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the WorkflowQueueModel class.
        /// </summary>
        /// <param name="workflowType">Gets or sets the type of the workflow.
        /// Possible values include: 'Uncategorized', 'Auto',
        /// 'StraightThrough', 'Exception', 'Holding', 'Any'</param>
        /// <param name="index">Gets or sets the index.</param>
        /// <param name="subIndex">Gets or sets the subindex.</param>
        ...
        /// 2.</param>
        public WorkflowQueueModel(string workflowType = default(string), int? index = default(int?), int? subIndex = default(int?), int? id = default(int?), int? userCount = default(int?), int? taskCount = default(int?), string name = default(string), string alias = default(string), string state = default(string), string type = default(string), string category = default(string), string description = default(string), int? reservedInt1 = default(int?), int? reservedInt2 = default(int?), string reservedString1 = default(string), string reservedString2 = default(string))
        {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "SubIndex")]
