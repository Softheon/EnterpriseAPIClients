...
namespace Softheon.Enterprise.Api.Client.Models
{
    ...
    /// </summary>
    public partial class UpdateAttachmentRequestModel
    {
        /// <summary>
        /// Initializes a new instance of the UpdateAttachmentRequestModel
        /// class.
        /// </summary>
        public UpdateAttachmentRequestModel()
        {
            CustomInit();
        }
        ...
        public UpdateAttachmentRequestModel(int? category = default(int?), int? classProperty = default(int?), string name = default(string), int? acl = default(int?), int? pageNumber = default(int?), string state = default(string), string note = default(string))
        {
            Category = category;
