 ...
 */
public class WorkflowQueueModel {
    /**
     * Gets or sets the type of the workflow. Possible values include:
     * 'Uncategorized', 'Auto', 'StraightThrough', 'Exception', 'Holding',
     * 'Any'.
     */
    ...
    /**
     * Gets or sets the subindex.
     */
    @JsonProperty(value = "SubIndex")
    ...
    /**
     * Get the workflowType value.
     *
     * @return the workflowType value
     */
    ...
    /**
     * Set the workflowType value.
     *
     * @param workflowType the workflowType value to set
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withWorkflowType(String workflowType) {
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withIndex(Integer index) {
        this.index = index;
        return this;
    }

    /**
     * Get the subIndex value.
     *
     * @return the subIndex value
     */
    ...
    /**
     * Set the subIndex value.
     *
     * @param subIndex the subIndex value to set
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withSubIndex(Integer subIndex) {
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withId(Integer id) {
        this.id = id;
        return this;
    }
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withUserCount(Integer userCount) {
        this.userCount = userCount;
        return this;
    }

    /**
     * Get the taskCount value.
     *
    ...
    /**
     * Set the taskCount value.
     *
     * @param taskCount the taskCount value to set
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withTaskCount(Integer taskCount) {
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withAlias(String alias) {
        this.alias = alias;
        return this;
    }
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withState(String state) {
        this.state = state;
        return this;
    }
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withCategory(String category) {
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withDescription(String description) {
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withReservedInt1(Integer reservedInt1) {
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withReservedInt2(Integer reservedInt2) {
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withReservedString1(String reservedString1) {
     ...
     * @return the WorkflowQueueModel object itself.
     */
    public WorkflowQueueModel withReservedString2(String reservedString2) {
