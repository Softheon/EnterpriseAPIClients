...
public class QueueModel {
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withId(Integer id) {
        this.id = id;
        return this;
    }
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withUserCount(Integer userCount) {
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withTaskCount(Integer taskCount) {
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withAlias(String alias) {
        this.alias = alias;
        return this;
    }
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withState(String state) {
        this.state = state;
        return this;
    }
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withCategory(String category) {
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withDescription(String description) {
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withReservedInt1(Integer reservedInt1) {
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withReservedInt2(Integer reservedInt2) {
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withReservedString1(String reservedString1) {
     ...
     * @return the QueueModel object itself.
     */
    public QueueModel withReservedString2(String reservedString2) {
