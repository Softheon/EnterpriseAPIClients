...
class EntityDefinitionModel {
  /**
   * Create a EntityDefinitionModel.
  ...
  /**
   * Defines the metadata of EntityDefinitionModel
   *
   * @returns {object} metadata of EntityDefinitionModel
   *
   */
  mapper() {
    return {
...
module.exports = EntityDefinitionModel;
